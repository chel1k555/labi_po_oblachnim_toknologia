...
Далее используя данные из таблички, инфу из первой лабы, мой невероятный опыт, я гуглил название сервиса, далее много думал и сопоставлял
Готову табличку прикрепил в этой папке.


## Вывод

В ходе лабораторной работы были получены навыки анализа и нормализации биллинговых данных облачного провайдера. Было показано, что даже вендор данные могут быть приведены к универсальной модели, пригодной для аналитики и сравнения различных облачных решений.
